...
public class TaskStringGenerator {
    ...
    private Logger logger = LoggerFactory.getLogger(TaskStringGenerator.class);


    public String generator(List<WordResult> newWordResults,List<WordResult> oldWordReults){
        ...
        try {
            ...
            logger.error("generate String failed!",e);
        }
        return result;
    }
